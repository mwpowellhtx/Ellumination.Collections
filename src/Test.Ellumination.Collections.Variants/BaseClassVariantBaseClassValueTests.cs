...
namespace Ellumination.Collections.Variants
{
    ...
    public class BaseClassVariantBaseClassValueTests : VariantBaseClassValueTestFixtureBase<BaseClass>
    {
        public BaseClassVariantBaseClassValueTests(ITestOutputHelper outputHelper)
            // ReSharper disable once RedundantEmptyObjectOrCollectionInitializer
            : base(outputHelper, new BaseClass { })
        {
        }
        ...
        public static IEnumerable<object[]> CanReplaceTestCases
        {
            get
            {
                IEnumerable<object[]> GetAll()
                {
                    ...
                    yield return GetRange<object>((BaseClass) null).ToArray();
                }
...
#pragma warning disable xUnit1008 // Test data attribute should only be used on a theory
        ...
        public override void Can_Replace_Like_Types(BaseClass value) => base.Can_Replace_Like_Types(value);
#pragma warning restore xUnit1008 // Test data attribute should only be used on a theory
        ...
        public static IEnumerable<object[]> CannotReplaceTestCases
        {
            get
            {
                ...
                {
                    // ReSharper disable once RedundantEmptyObjectOrCollectionInitializer
                    yield return GetRange<object>(long.MaxValue).ToArray();
