namespace Ellumination.Collections.Generic
{
    ...
    public delegate void BidirectionalSingletonOnClause<in T>(T old, T current);
    ...
    /// <param name="current"></param>
    /// <returns></returns>
    public delegate bool TryBidirectionalSingletonOnSetClause<in T>(T old, T current);
}
